%% ============================================
%% 公平对比：所有控制器在同一 Simulink 模型上
%% ============================================
%% 对比算法：
%% 1. 规则型控制器 (Rule-Based) - 基准方法
%% 2. PID 控制器 - 经典控制
%% 3. MPC 控制器 - 高级经典控制
%% 4. 基础 Q-Learning - 基础强化学习
%% 5. DQN+LSTM ⭐ - 深度强化学习（最先进）
%% ============================================
...
% 加载温度数据
data = load('data/temperatureMar21toApr15_2022.mat');
...
fprintf('5. DQN+LSTM... ');
load("data/HeatControlDQNAgent.mat", "agent");
